...
//     res.redirect("/allresults/dashboard"); // Redirect to the teacher's dashboard
//   } catch (error) {
//     console.error(error);
...
// // Controller to fetch and render all the results
...
// //     res.render("allresults/dashboard", { results: results });
// //   } catch (error) {
// //     console.error(error);
// //     res.status(500).json({ message: "Server error" });
// //   }
...
// //   editResult,
// //   deleteResult,
// //   viewAllResults, // Add the new controller function
// // };
